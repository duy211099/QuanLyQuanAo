...
{
    public partial class ThongKeGiamDoc : Form
    {
        string batdau;
        string ketthuc;
        public ThongKeGiamDoc()
        {
            InitializeComponent();
        }
        ...
        private void showThongKeCN2<T>(List<T> list)
        {
            lvwThongKeCN2.Items.Clear();
            lvwThongKeCN2.Columns.Clear();
            ...
            foreach (var property in propertiesArr)
            {
                ...
                lvwThongKeCN2.Columns.Add(property);
            }
            foreach (var row in list)
            {
                temp = row.ToString().Split('|');
                ...
                lvwThongKeCN2.Items.Add(item);
            }

            for (int i = 0; i < propertiesArr.Length; i++)
            {

                lvwThongKeCN2.Columns[i].Width = -2;
            }
        }
        private void LoadThongKeSanPham()
        {
            if (cbbDetail.SelectedIndex == 0)
            {
                ...
                var list2 = DemoService.Run_SP<SanPhamBanChay>("LINK.CSDLPT1.dbo.sp_SpBanChay", batdau, ketthuc);
                showThongKeCN2(list2);
            }
            if (cbbDetail.SelectedIndex == 1)
            {
                ...
                var list2 = DemoService.Run_SP<SanPhamDoanhThu>("LINK.CSDLPT1.dbo.sp_SanPhamDoanhThu", batdau, ketthuc);
                showThongKeCN2(list2);
            }
            ...
            if (cbbDetail.SelectedIndex == 2)
            {
                ...
                var list2 = DemoService.Run_SP<SanPhamChuaBan>("LINK.CSDLPT1.dbo.sp_SpChuaBanDuoc", batdau, ketthuc);
                showThongKeCN2(list2);
            }
        }
        ...
        private void LoadThongKeNhanVien()
        {
            ...
            if (cbbDetailNV.SelectedIndex == 0)
            {
                ...
                var list2 = DemoService.Run_SP<ThongKeNhanVienDonHang>("LINK.CSDLPT1.dbo.sp_NVNhieuDonHang", batdau, ketthuc);
                showThongKeCN2(list2);
            }
            if (cbbDetailNV.SelectedIndex == 1)
            {
                ...
                var list2 = DemoService.Run_SP<ThongKeNhanVienDoanhThu>("LINK.CSDLPT1.dbo.sp_NVDoanhThu", batdau, ketthuc);
                showThongKeCN2(list2);
            }
            ...
            if (cbbDetailNV.SelectedIndex == 2)
            {
                ...
                var list2 = DemoService.Run_SP<ThongKeNhanVienKoBan>("LINK.CSDLPT1.dbo.sp_NVKoBanHang", batdau, ketthuc);
                showThongKeCN2(list2);
            }
        }
        ...
        private void LoadThongKeTong()
        {
            if (cbbTong.SelectedIndex == 0)
            {
                ...
                var list2 = DemoService.Run_SP<TongDoanhThu>("LINK.CSDLPT1.dbo.sp_TongDoanhThu", batdau, ketthuc);
                showThongKeCN2(list2);
            }
        }
